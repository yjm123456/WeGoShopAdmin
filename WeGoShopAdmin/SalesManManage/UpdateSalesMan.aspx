<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateSalesMan.aspx.cs" Inherits="WeGoShopAdmin.SalesManManage.UpdateSalesMan" %>
                        ...
                        <div id="LoginForm" lay-filter="addForm" class="layui-form">
                            <div class="layui-form-item">
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-inline">
                                        <div class="layui-input-inline">
                                            <asp:TextBox ID="SaleManId" Visible="true" autocomplete="off" class="layui-input" Style="display: none" runat="server"></asp:TextBox>
                            ...
                            <div class="layui-form-item">
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-inline">
                                        <select id="Level" runat="server" name="Level" asp-for="Level" lay-search="true" lay-filter="Level">
                                </select>
                                          <asp:TextBox ID="LevelId" Visible="true" autocomplete="off" class="layui-input" Style="display: none" runat="server"></asp:TextBox>
                                    </div>
                                </div>
