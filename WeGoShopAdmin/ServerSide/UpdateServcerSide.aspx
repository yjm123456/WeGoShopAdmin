<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateServcerSide.aspx.cs" Inherits="WeGoShopAdmin.ServerSide.UpdateServcerSide" %>
                            ...
                            <div class="layui-form-item">
                               ...
                               <div class="layui-form-item">
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-inline">
                                          <input type="text" name="StartDate" id="StartDate" runat="server"   lay-verify="required"  placeholder="yyyy-MM-dd" autocomplete="off" class="layui-input"/>
                                    </div>
                                </div>
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-inline">
                                        <div class="layui-input-inline">
                                            <asp:TextBox ID="Remark" autocomplete="off" class="layui-input" style="width:514px;"  runat="server"></asp:TextBox>
                                              <asp:TextBox ID="Id" autocomplete="off" class="layui-input"  runat="server" style="display:none"></asp:TextBox>
                                        </div>
