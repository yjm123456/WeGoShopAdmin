...
; (function ($, window, document, undefined) {
    ...
    $.idealforms.errors = {
        ...
        email: '必须是一个有效的e -mail地址. <em>(例如： user@gmail.com)</em>',
        phone: '电话格式必须输入正确<em>(例如： 0000-00000000)</em>',
        zip: 'Must be a valid US zip code. <em>(e.g. 33245 or 33245-0003)</em>',
        url: 'Must be a valid URL. <em>(e.g. www.google.com)</em>',
        minChar: '至少输入 <strong>{0}</strong> 个字符',
        minOption: '至少选择 <strong>{0}</strong> 个模块.',
