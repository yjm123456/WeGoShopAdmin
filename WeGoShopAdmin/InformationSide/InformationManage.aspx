<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InformationManage.aspx.cs" Inherits="WeGoShopAdmin.InformationSide.InformationManage" %>
            ...
            <div class="layui-body">
                ...
                <div class="layui-card">
                    <div class="layui-card-body layui-card-table-body">
                        <table id="InformationInfo"></table>
                    </div>
                </div>
            </div>
        ...
        var app = {
            init: function () {
                ...
                layui.table.render({
                    ...
                    elem: '#InformationInfo',
                    url: "../ApiControl/InformationPath/InformationPathInfo.ashx?CheckParam=Select", //数据接口
                    page: true, //开启分页
                    defaultToolbar: [],
                    cols: [[ //表头
                        { field: 'SendTarget', title: '发送目标', width: 120 },
            ...
            loadData: function () {
                var searchParams = layui.form.val("searchForm");
                layui.table.reload("InformationInfo", {
                    page: { curr: 1 },
                    where: { queryParams: searchParams }
                });
            },
            Insert: function (Id) {
                ...
                layer.open({
                    type: 2, area: ['790px', '548px'], title: '新增消息通知',
                    content: "InsertInformation.aspx",
                    btn: ["确定", "关闭"],
